...
/**
 * Recharts injects payload/active/coordinate at render time; callers may only pass overrides
 * (e.g. `indicator`) when using `<ChartTooltip content={<ChartTooltipContent ... />} />`.
 */
